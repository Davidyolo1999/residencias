                        ...
                        <tbody>
                            @forelse ($periods as $period)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $period->start->format('M Y') }} - {{ $period->end->format('M Y') }}</td>                                    
                                    <td class=" td-actions text-nowrap text-center ">                                        
                                        <a href="{{ route('periods.edit', $period) }}" class="btn btn-sm btn-info btn-success" title="Editar" >
