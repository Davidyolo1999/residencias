...
class CreateAuthorizationLettersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('authorization_letters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('authorization_letters');
    }
}
