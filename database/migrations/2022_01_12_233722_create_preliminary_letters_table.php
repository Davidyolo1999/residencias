...
class CreatePreliminaryLettersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('preliminary_letters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('preliminary_letters');
    }
}
